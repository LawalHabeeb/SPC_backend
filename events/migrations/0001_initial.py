# Generated by Django 4.0.5 on 2022-07-05 18:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FeaturedImage', models.ImageField(blank=True, upload_to='images')),
                ('enddateandtime', models.DateTimeField(blank=True, null=True)),
                ('Location', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='events.eventlocation')),
                ('Organizers', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='events.eventorganizer')),
            ],
        ),
    ]
